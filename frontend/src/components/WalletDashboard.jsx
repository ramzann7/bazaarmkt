        ...
        <div className="card p-6">
          ...
          {transactionSummary ? (
            ...
            <div className="text-center py-4 text-stone-500">
              <p>{t('walletDashboard.noTransactionData')}</p>
            </div>
          )}
        </div>
          ...
          <div className="space-y-4">
            {hasBankInfo ? (
              ...
              <div className="text-center py-6 text-stone-500">
                ...
                <p className="text-sm mb-4">{t('walletDashboard.addBankAccount')}</p>
                <a
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-stone-500">{t('walletDashboard.seeCompleteActivity')}</p>
            </div>
          </div>
        </button>
      </div>
