...
// ============================================================================
// PRODUCT ENDPOINTS - Now handled by Product Service microservice
// ============================================================================
// All product endpoints are now handled by the Product Service microservice
// Routes: /api/products/* are automatically routed to the microservice

// ============================================================================
// AUTHENTICATION ENDPOINTS - Now handled by User Service microservice
// ============================================================================
// All authentication endpoints are now handled by the User Service microservice
// Routes: /api/auth/* are automatically routed to the microservice

// ============================================================================
// ORDER MANAGEMENT ENDPOINTS - Now handled by Order Service microservice
// ============================================================================
// All order endpoints are now handled by the Order Service microservice
// Routes: /api/orders/* are automatically routed to the microservice

// ============================================================================
// FILE UPLOAD ENDPOINTS - Now handled by File Service microservice
// ============================================================================
// All file upload endpoints are now handled by the File Service microservice
// Routes: /api/upload/* are automatically routed to the microservice

// ============================================================================
// ARTISAN ENDPOINTS - Now handled by Artisan Service microservice
// ============================================================================
// All artisan endpoints are now handled by the Artisan Service microservice
// Routes: /api/artisans/* are automatically routed to the microservice

// ============================================================================
// PROMOTIONAL ENDPOINTS - Now handled by Promotional Service microservice
// ============================================================================
// All promotional endpoints are now handled by the Promotional Service microservice
// Routes: /api/promotional/* are automatically routed to the microservice

// ============================================================================
// COMMUNITY ENDPOINTS - Now handled by Community Service microservice
// ============================================================================
// All community endpoints are now handled by the Community Service microservice
// Routes: /api/community/* are automatically routed to the microservice

// ============================================================================
// INVENTORY MANAGEMENT ENDPOINTS - Now handled by Product Service microservice
// ============================================================================
// All inventory management endpoints are now handled by the Product Service microservice
// Routes: /api/products/*/inventory are automatically routed to the microservice

// ============================================================================
// ADDITIONAL SERVICES ENDPOINTS - Now handled by respective microservices
// ============================================================================
// All additional service endpoints are now handled by their respective microservices
// Routes are automatically routed to the appropriate microservices
...
// Get artisan orders - Get orders for the authenticated artisan
app.get('/api/orders/artisan', async (req, res) => {
  try {
    ...
    // Get artisan profile from artisans collection
    const artisanProfile = await artisansCollection.findOne({ 
    ...
    const artisanId = artisanProfile._id;
    
    // Get orders for this artisan
    const ordersCollection = db.collection('orders');
    const query = { 'items.artisanId': new (require('mongodb')).ObjectId(artisanId) };
...
// Upload endpoints - Now handled by File Service microservice
/*
...
// Reviews endpoints - Now handled by Reviews Service microservice
...
// Favorites endpoints - Now handled by Favorites Service microservice
...
// app.delete('/api/community/posts/:postId/like', communityFeatures.likePost);

// Community comments - Now handled by Community Service microservice
...
// Community stats and leaderboards - Now handled by Community Service microservice
...
// Spotlight - Now handled by Spotlight Service microservice
// app.get('/api/spotlight/status', additionalFeatures.getSpotlightStatus);

// Wallet - Now handled by Wallet Service microservice
...
// Geocoding - Now handled by Geocoding Service microservice
// app.post('/api/geocoding/address', additionalFeatures.geocodeAddress);

// Revenue - Now handled by Revenue Service microservice
// app.get('/api/revenue/artisan', additionalFeatures.getArtisanRevenue);

// Admin - Now handled by Admin Service microservice
// app.get('/api/admin/stats', additionalFeatures.getAdminStats);

// Enhanced search - Now handled by Search Service microservice
// app.get('/api/search/enhanced', additionalFeatures.enhancedSearch);

// Business analytics - Now handled by Analytics Service microservice
