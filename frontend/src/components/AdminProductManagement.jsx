            ...
            <div key={product._id} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-600 mb-2">
                  by {product.artisan?.artisanName || `${product.seller.firstName} ${product.seller.lastName}`}
                </p>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex space-x-2">
                    ...
                    <button
                      ...
                      className={`p-1 ${product.isFeatured ? 'text-yellow-600 hover:text-yellow-900' : 'text-gray-400 hover:text-yellow-600'}`}
                    >
                      <StarIcon className={`w-4 h-4 ${product.isFeatured ? 'fill-current' : ''}`} />
                    </button>
                  </div>
