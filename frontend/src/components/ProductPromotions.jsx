...
export default function ProductPromotions({ product, onPromotionUpdate }) {
  ...
  // Add a refresh mechanism to get updated pricing
  useEffect(() => {
    const refreshInterval = setInterval(() => {
      loadPromotionalData();
    }, 30000); // Refresh every 30 seconds to get updated pricing
    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-bold text-gray-900">Choose Your Promotion</h3>
          <button
          ...
          >
            ...
            {isLoading ? 'Loading...' : 'Refresh Pricing'}
          </button>
        </div>
        {lastUpdated && (
          <p className="text-xs text-gray-500 text-center mb-4">
            Pricing last updated: {lastUpdated.toLocaleTimeString()}
          </p>
        )}
